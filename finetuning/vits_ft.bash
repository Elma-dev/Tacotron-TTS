...
tts --model_name tts_models/en/ljspeech/vits --text "HELLO"

# Adjust configuration file
vim /root/.local/share/tts/tts_models--en--ljspeech--vits/config.json
...
--config_path /root/.local/share/tts/tts_models--en--ljspeech--vits/config.json \
